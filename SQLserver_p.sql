CREATE TABLE ct_documentos (
  id_doc int NOT NULL  IDENTITY(1,1) PRIMARY KEY,
  nombre_documento varchar(265) NOT NULL,
  documentos varchar(6) NOT NULL,
  prefijo varchar(15) NOT NULL
) ;

SET IDENTITY_INSERT ct_documentos ON

INSERT INTO ct_documentos (id_doc, nombre_documento, documentos, prefijo) VALUES (0, 'Documento de Identificación Oficial Credencial para votar del INE', 'INE', 'doc1'), (1, 'FOMOPE', 'FMP', 'doc12'), (2, 'Convocatoria con Acuse de Recibo por parte de la Dirección Administrativa o Responsable de la Unidad', 'AUR', 'doc123');

SET IDENTITY_INSERT ct_documentos OFF


CREATE TABLE ct_unidades (
  id_ur int NOT NULL  IDENTITY(1,1) PRIMARY KEY,
  clave_ur varchar(4)  NOT NULL,
  descripcion varchar(200)  NOT NULL,
  ramo varchar(4)  NOT NULL
) ;

SET IDENTITY_INSERT ct_unidades ON
...
SET IDENTITY_INSERT ct_unidades OFF

SELECT * from ct_unidades

CREATE TABLE registro (
  id_encuesta int NOT NULL IDENTITY(1,1) PRIMARY KEY,
  ...
  motivo_rechazo varchar(110)  NOT NULL
) ;
...
CREATE TABLE usuarios (
  ...
  id_numUser int NOT NULL IDENTITY(1,1) PRIMARY KEY
) ;
